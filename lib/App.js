...
class App {
  ...
  async runDocker({
    ...
    if (widgetHostId && widgetHostUrl) {
      manifest.widgets[widgetHostId].url = widgetHostUrl;
    }
      ...
      for (const [widgetId, widget] of Object.entries(appJson.widgets)) {
        ...
        try {
          ...
          await Promise.all([
            ...
            image.resize(128, 128).toFile(path.join(this._homeyBuildPath, 'widgets', widgetId, '__assets__', 'preview-light@1x.png')),
            image.resize(192, 192).toFile(path.join(this._homeyBuildPath, 'widgets', widgetId, '__assets__', 'preview-light@1.5x.png')),
            image.resize(256, 256).toFile(path.join(this._homeyBuildPath, 'widgets', widgetId, '__assets__', 'preview-light@2x.png')),
            image.resize(384, 384).toFile(path.join(this._homeyBuildPath, 'widgets', widgetId, '__assets__', 'preview-light@3x.png')),
            image.resize(512, 512).toFile(path.join(this._homeyBuildPath, 'widgets', widgetId, '__assets__', 'preview-light@4x.png')),
            fs.promises.copyFile(previewLightPath, path.join(this._homeyBuildPath, 'widgets', widgetId, '__assets__', 'preview-dark.png')),
            image.resize(128, 128).toFile(path.join(this._homeyBuildPath, 'widgets', widgetId, '__assets__', 'preview-dark@1x.png')),
            image.resize(192, 192).toFile(path.join(this._homeyBuildPath, 'widgets', widgetId, '__assets__', 'preview-dark@1.5x.png')),
            image.resize(256, 256).toFile(path.join(this._homeyBuildPath, 'widgets', widgetId, '__assets__', 'preview-dark@2x.png')),
            image.resize(384, 384).toFile(path.join(this._homeyBuildPath, 'widgets', widgetId, '__assets__', 'preview-dark@3x.png')),
            image.resize(512, 512).toFile(path.join(this._homeyBuildPath, 'widgets', widgetId, '__assets__', 'preview-dark@4x.png')),
          ]);
        } catch (error) {
          throw error;
        }
