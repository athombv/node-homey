...
class App {
  ...
  async runDocker({
    ...
    const { HOMEY_APP_RUNNER_SDK_PATH } = process.env; // e.g. /Users/username/Git/node-homey-apps-sdk-v3
    ...
    Log(colors.green(`✓ Started Local HTTP Server at http://0.0.0.0:${serverPort}`));
    ...
    Log(colors.green(`✓ Debugger running at 0.0.0.0:${inspectPort}. Open \`about://inspect\` in Google Chrome and select the target.`));
