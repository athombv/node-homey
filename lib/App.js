...
- Never translate placeholders between [[ and ]]. Even if the name of the placeholder is not valid, it should be treated as a placeholder.
- Do translate options within brackets, for example: {{yes/no}}.
