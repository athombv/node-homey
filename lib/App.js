...
3. Do not overwrite existing translations from ${languages.join(', ')} keys.
   - keep it unchanged.
...
4. Only translate translation objects that have an "en" property.
   ...
   - Use "en" (English) as the base translation.
   - Never translate IDs between [[ and ]].
   - Don't translate Brand names. For example, "MyBrand" should stay as "MyBrand".
6. Do not “correct” or “guess” translations; only translate using the provided English text as source.
7. Tone of voice: casual, friendly, helpful.
8. Always return the original file exactly as submitted. The only changes may be newly added languages.
9. Only output the new JSON file. No text. Don't format it as JSON. Don't output === START FILE ===.
