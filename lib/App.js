...
You can create an API Key on https://platform.openai.com/api-keys.`);
    ...
    await Promise.all(jsonFiles.slice(0, 1).map(async file => {
      try {
        ...
        Don't touch any other properties.
        ...
        await fs.promises.writeFile(file, chatResult.choices[0].message.content);
