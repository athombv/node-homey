...
class AthomApi {
  constructor({
    ...
    useLegacyPersonalAccessToken = true,
    ...
    this._useLegacyPersonalAccessToken = useLegacyPersonalAccessToken;
  ...
  _createApi() {
    ...
    const personalAccessToken =
      ...
      (this._useLegacyPersonalAccessToken ? process.env.HOMEY_PAT : null);
