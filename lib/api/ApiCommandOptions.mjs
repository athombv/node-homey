...
import { applyUsbOption } from '../UsbOption.mjs';
...
export function applyJqOutputOption(yargs) {
...
export function applyHomeyApiTargetOptions(yargs) {
  return applyUsbOption(applyHomeyIdOption(applyHomeyAddressOption(applyHomeyTokenOption(yargs))));
}
